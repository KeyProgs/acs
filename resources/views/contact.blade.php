@extends('layouts.app')
@section('content')
    @include('includes.breadcrumb.page-header',['home'=>'accueil','page'=>'Contact','title'=>'Nous Contacter'])
                ...
                <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
                    <div class="contact-box-content">
                        <div class="img-holder">
                            <img title="Acs assurance contact" src="{{asset('/images/resources/contact.jpg')}}"
                                 alt="Acs Assurance contact">
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                                    <div class="quick-contact-box">
                                        ...
                                        <div class="map-find">
                                            <a class="btn-two" title="nous trouver" href="#">Nous trouvez sur la
                                                carte<span class="flaticon-next"></span></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="contact-form">
                        ...
                        <form id="contact-form" name="contact_form" class="default-form"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-box">
                                        <select class="selectmenu" name="motif">
                                            <option value="" selected="selected">pour quoi nous contacter</option>
                                            <option value="Service Generale">Service Generale</option>
                                            <option value="Recouvrement">Recouvrement</option>
                                            <option value="Information">Information</option>
                                            <option value="Souscription">Souscription</option>
                                            <option value="Info Medecins">Info Medecins</option>
                                            <option value="Rembourcement">Rembourcement</option>
                                        </select>
                                        @if ($errors->has('motif'))
                                            <span class="help-block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-box captcha">
                                        <span style="float: left !important;">{!! captcha_img() !!}</span>
                                        <button style="float: left !important; width: 10%;padding: 0 !important;height: 36px !important;"
                                                type="button"
                                                class="btn btn-success btn-refresh">
                                            <i class="fa fa-refresh"></i>
                                        </button>
                                        <input type="text" id="captcha" placeholder="Veuillez saisir le captcha"
                                               name="captcha"
                                        >
                                    ...
                                    <div class="accordion accordion-block">
                                        ...
                                        <div class="accord-content collapsed">
                                            <div class="single-box">
                                                ...
                                                <div class="map-find">
                                                    <a class="btn-two" title="nous trouver" href="#">Nous trouver sur la
                                                        carte<span class="flaticon-next"></span></a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-xl-12">
                    <div class="appointment-right-style2 text-center">
                        ...
                        <div class="button">
                            ...
                            <a class="btn-two" href="#" title="un devis !">Un Devis<span
                                        class="flaticon-next"></span></a>
                        </div>
                    </div>
                </div>
